...
## [<img src="https://github.com/QuantLet/Styleguide-and-FAQ/blob/master/pictures/qloqo.png" alt="Visit QuantNet">](http://quantlet.de/) **confMA** [<img src="https://github.com/QuantLet/Styleguide-and-FAQ/blob/master/pictures/QN2.png" width="60" alt="Visit QuantNet 2.0">](http://quantlet.de/)

```yaml

Name of QuantLet : confMA

Published in : SPL

Description : Draws a confusion matrix for a binary prediction model

Keywords : 'logistic regression, score, confusion matrix'

Author : Tobias Blücher, Niklas Kudernak, Sydney Richards

```
![Picture1](Confusion_Normalization.png)
![Picture2](Confusion_No_Normalization.png)
